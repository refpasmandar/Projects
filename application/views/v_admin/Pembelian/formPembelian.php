<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h6 class="text-primary font-weight-bold"><i class="fas fa-cart-arrow-down mr-2"></i>Pembelian</h6>
        </div>
        <div class="card-body">
            <?php $this->view('flashdata') ?>
            <form action="<?php echo base_url('Pembelian/Pembelian/tambahPembelian') ?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-header">
