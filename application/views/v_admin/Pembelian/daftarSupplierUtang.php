            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= ($subhal == 'daftarSupplierUtang') ? 'active' : ''; ?>" href="<?= base_url('Pembelian/Pembelian/daftarSupplierUtang') ?>">UTANG</a>
                        </li>
                    </ul>
                                ...
                                <?php foreach ($all as $t) : ?>
                                    <?php if ($t->total_utang < 0) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="<?= base_url(); ?>Pembelian/Pembelian/detailPembelian/<?= $t->id_supplier; ?>" class="btn btn-info"><i class="fas fa-file-invoice-dollar"></i> Invoice</a></td>
                                        </tr>
                                    <?php } ?>
                                <?php endforeach ?>
                            </tbody>
