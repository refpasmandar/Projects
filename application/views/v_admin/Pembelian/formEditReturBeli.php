<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-exchange-alt mr-1"></i>Form Edit Retur Pembelian</h6>
        </div>
        <div class="card-body">
            <form action="<?php echo base_url('Pembelian/Pembelian/prosesEditReturBeli') ?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-header">
                            ...
                            <?php foreach ($single as $s) : ?>
                                <?php if ($s->jenis_transaksi == 'Retur Pembelian') { ?>
                                    <!-- get id Jurnal -->
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="date" id="tanggal_transaksi" name="tanggal_transaksi" placeholder="Text" class="form-control" value="<?php echo $tanggal ?>" readonly>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select class="form-control" name="id_supplier" id="id_supplier" readonly>
                                                <option value="0" disabled>-- Pilih Pemasok --</option>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="id_transaksi[]" id="id_transaksi" value="<?= $gp->id_returbeli ?>">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                            ...
                                            <td>
                                                <?php
                                                $qty = $this->db->query("SELECT qty_beli,diskon_beli from tb_transaksibeli where kode_jurnal = '$gp->kode_jurnal' and id_barang = '$gp->id_barang'")->row_array(); ?>
                                                <div class="form-group">
                                                    <input class="form-control" id="qty_beli<?php echo $no ?>" type="number" value="<?php echo $qty['qty_beli'] ?>" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input class="form-control" id="jumlahRetur<?php echo $no ?>" type="number" value="<?php echo $gp->jumlahRetur ?>" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input class="form-control no_akun" name="diskon_beli[]" id="diskon_beli<?php echo $no ?>" type="text" value="<?php echo $qty['diskon_beli'] ?>" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input class="form-control qty" name="qty[]" id="qty_retur<?php echo $no ?>" type="number" value="<?php echo $gp->qty_returbeli ?>" data-qty_lama="<?php echo $gp->qty_returbeli ?>">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input class="form-control total_retur" name="total[]" id="total_retur<?php echo $no ?>" type="text" value="<?php echo $gp->total_returbeli ?>" readonly>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php $no++;
