...
<div class="container-fluid">
    <p class="title_halaman"><i class="fas fa-money-bill mr-1"></i> Bayar Utang</p>
    <hr>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Bayar Utang</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('Pembelian/Pembelian/prosesBayarUtang') ?>" method="post">
            ...
            <div class="text-center mt-4">
                <button type="submit" id="jurnal_entry" name="tambah" class="btn btn-submit btn-primary font-weight-bold" onclick="balance(event)"><i class="fas fa-money-bill mr-1"></i>Bayar
                </button>
