<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h6 class="text-primary font-weight-bold"><i class="fas fa-cart-arrow-down mr-2"></i>Penjualan</h6>
        </div>
        <div class="card-body">
            <?php $this->view('flashdata') ?>
            <form method="post" action="<?php echo base_url('Penjualan/Penjualan/tambahPenjualan') ?>">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-header">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <input type="hidden" name="jenis_transaksi" id="jenis_transaksi" value="Penjualan">
                    ...
                    <div class="col-lg-3 mt-4">
                        <button class="btn btn-primary btn-submit col-lg-5 mr-4" type="submit" id="prosesJual"><i class="fas fa-save mr-1"></i> Simpan</button>
