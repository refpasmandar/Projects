<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-exchange-alt mr-1"></i>Retur Penjualan</h6>
        </div>
        <div class="card-body">
            <form action="<?php echo base_url('Penjualan/Penjualan/prosesReturJual') ?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-header">
                            ...
                            <?php foreach ($single as $s) : ?>
                                <?php if ($s->jenis_transaksi == 'Penjualan' || $s->jenis_transaksi == 'Piutang Awal') { ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            <input type="date" name="tanggal_jual" value="<?php echo $tanggal ?>" hidden>
                                    ...
                                    foreach ($listBarang as $gp) { ?>
                                        <tr>
                                            ...
                                            <?php if ($gp->qtyRetur == 0) { ?>
                                                <td>
                                                    <div class="form-group">
                                                        <input class="form-control" id="qty_beli<?php echo $no ?>" type="number" value="<?php echo $gp->qty_jual ?>" readonly>
                                                    </div>
                                                </td>
                                            <?php } else { ?>
                                                <td>
                                                    <div class="form-group">
                                                        <input class="form-control" id="qty_beli<?php echo $no ?>" type="number" value="<?php echo $gp->totalQtyJual ?>" readonly>
                                                    </div>
                                                </td>
                                            <?php } ?>
                                            <td>
                                                <div class="form-group">
                                                    <input class="form-control no_akun" name="diskon_beli[]" id="diskon_beli<?php echo $no ?>" type="text" value="<?php echo $gp->diskon_jual ?>" readonly>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <input class="form-control qty" name="qty[]" id="qty_retur<?php echo $no ?>" type="number">
                                                    <?php echo form_error('qty[]') ?>
                                                </div>
                                            </td>
                                            <!-- <td>
                                                <div class="form-group">
                                                    <input class="form-control no_akun" name="satuan_beli[]" id="satuan<?php echo $no ?>" type="text" value="<?php echo $gp->satuan_beli ?>" readonly>
                                                </div>
                                            </td> -->
                                            <!-- <td>
                                                <div class="form-group">
                                                    <input class="form-control disc" name="diskon[]" id="diskon<?php echo $no ?>" value="<?php echo $gp->diskon ?>" type="text">
                                                </div>
                                            </td> -->
                                            <td>
                                                <div class="form-group">
                                            ...
                                            <td hidden>
                                                <div class="form-group">
                                                    <input class="form-control total_hpp" name="total_hpp[]" id="total_hpp<?php echo $no ?>" type="text" readonly>
                                                </div>
                                            </td>
                                            <td hidden>
