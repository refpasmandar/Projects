<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="text-primary font-weight-bold"><i class="fas fa-cart-arrow-down mr-2"></i>
                Form Edit Piutang Awal</small>
            </h6>
        </div>
        <div class="card-body">
            <?php $this->view('flashdata') ?>
            <form action="<?php echo base_url('Master_data/Customer/prosesEditPiutangAwal') ?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card-header">
                            <?php foreach ($single as $s) : ?>
                                <?php if ($s->jenis_transaksi == 'Piutang Awal') { ?>
                                    <?php foreach ($jurnal as $jur) : ?>
                                        <?php if ($jur->jenis_transaksi == 'Piutang Awal') { ?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            <input type="hidden" id="jenis_transaksi" name="jenis_transaksi" value="Piutang Awal">
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control id_barang" name="id_barang[]" id="id_barang<?php echo $no ?>">
                                                            ...
                                                            <?php foreach ($barang as $brg) { ?>
                                                                <option value="<?php echo $brg->id_barang ?>" <?php echo $brg->id_barang == $lb->id_barang ? 'selected' : '' ?> data-kode_barang="<?php echo $brg->kode_barang ?>" data-kode_pabrik="<?php echo $brg->kode_pabrik ?>" data-harga_beli="<?php echo $brg->harga_beli ?>" data-satuan="<?php echo $brg->satuan_jual ?>" data-hpp="<?php echo $brg->hpp ?>">
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control total_awal" name="total_awal" id="total_awal<?php echo $no ?>" type="hidden" value="<?php echo $lb->total_jual ?>">
                                                    </div>
                                                </td>
                                                <td hidden>
                                                    <div class="form-group">
...
<script>
    ...
    $(document).on('keyup keydown click change', function() {
        ...
        $('#batasPiutang').val(saldoPiutang - ((grand_total - jumlah_bayar) - batasPiutang));
