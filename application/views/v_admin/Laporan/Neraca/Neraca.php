                                ...
                                <tbody>
                                    ...
                                    foreach ($neraca_pasiva as $na) { ?>
                                        <tr class="">
                                            ...
                                            <?php } else { ?>
                                                <?php
                                                $akunModal = $this->db->query("SELECT id_akun from tb_linkacc where keterangan_link = 'Akun Modal'")->row_array();
                                                ?>
                                                <td class="level_4"><?= $na->kode_akun . "-" . $na->no_akun ?></td>
                                                <td class="level_4"><?= $na->nama_akun ?></td>
                                                <?php if ($na->total == 0 && $na->saldo_awal == 0) { ?>
                                                ...
                                                <?php } else if ($na->total == 0) { ?>
                                                    <?php if ($na->id_akun == $akunModal['id_akun']) { ?>
                                                        <?php
                                                        $modalAwal = substr($na->saldo_awal, 1);
                                                        $modalAkhir = $modalAwal + ($pendapatan - $pengeluaran);
                                                        ?>
                                                        <td class="level_4 text-right">
                                                            Rp <?php echo substr(number_format($modalAkhir, 0, ',', '.'), 0) ?>
                                                        </td>
                                                        <?php $total_pasiva = $total_pasiva + ($na->saldo_awal - ($pendapatan - $pengeluaran)) ?>
                                                    <?php } else { ?>
                                                        <td class="level_4 text-right">Rp <?php echo substr(number_format($na->saldo_awal, 0, ',', '.'), 1) ?></td>
                                                        <?php $total_pasiva = $total_pasiva + $na->saldo_awal ?>
                                                    <?php } ?>
